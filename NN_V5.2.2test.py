...
f = h5py.File('data/dark_100.h5', 'r')
...
model_None.load_state_dict(torch.load('cnn_noformat_100.pt'))
...
plt.title(r"testing precision results for different data format (test data 100keV events)", **title_font)
#plt.legend(loc=2,prop =legend_font)
plt.grid(True)
plt.savefig('comparaison_data_formats_otherform_test_100.png', bbox_inches='tight')
plt.close(fig)
...
plt.ylabel(r"Precision in $\%$", **axis_font)
plt.title(r"testing precision results different multiplicative factor (test data 100keV events) ", **title_font)
#plt.legend(loc=2,prop =legend_font)
plt.grid(True)
plt.savefig('comparaison_multiply_test_dark_100.png', bbox_inches='tight')
plt.close(fig)
trainloader2 = torch.utils.data.DataLoader(trainloader, batch_size=batch_size,
                                           shuffle=False, num_workers=0)
ls_error=[]
...
plt.ylabel(r"Precision in $\%$", **axis_font)
plt.title(r" different data format( train data 100keV events)", **title_font)
#plt.legend(loc=2,prop =legend_font)
plt.grid(True)
plt.savefig('comparaison_data_formats_train_100.png', bbox_inches='tight')
plt.close(fig)
...
plt.xlabel(r"mutlifly factor", **axis_font)
plt.ylabel(r"Precision in $\%$", **axis_font)
plt.title(r" different multiplicative factor(train data 100keV events)", **title_font)
#plt.legend(loc=2,prop =legend_font)
plt.grid(True)
plt.savefig('comparaison_multiply_dark_100_train.png', bbox_inches='tight')
plt.close(fig)
