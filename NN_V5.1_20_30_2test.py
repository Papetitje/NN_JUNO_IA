...
plt.title(r"Loss in function of the number of mini-batches used for training (NN shape 20 30 2)", **title_font)
plt.legend(loc=2,prop =legend_font)
plt.grid(True)
plt.savefig('loss20_30_2_.png', bbox_inches='tight')
plt.close(fig)
...
plt.title(r"testing results after each epoch (NN shape 20 30 2)", **title_font)
plt.legend(loc=2,prop =legend_font)
plt.grid(True)
plt.savefig('prediction20_30_2_.png', bbox_inches='tight')
plt.close(fig)

a_dict_net = net.state_dict()
torch.save(a_dict_net,"cnn_noformat_20_30_2.pt")
model_None= Net().float()
model_None.load_state_dict(torch.load('cnn_noformat_20_30_2.pt'))
...
for i in range(len(ls_digit)):
    ...
    total=0.0
    digit=ls_digit[i]
    filename = "To_FPGA_20_30_2_"+str(digit)+".txt"
    filename3 = "To_FPGA_20_30_2_"+str(digit)+"dec.txt"
    filename2 = "cnn20_30_2_"+str(digit)+".pt"
...
plt.title(r"testing results for different data format (NN shape 20 30 2)", **title_font)
#plt.legend(loc=2,prop =legend_font)
plt.grid(True)
plt.savefig('comparaison_data_formats_otherform20_30_2_.pdf', bbox_inches='tight')
plt.close(fig)
...
#plt.legend(loc=2,prop =legend_font)
plt.grid(True)
plt.savefig('comparaison_multiply20_30_2_.pdf', bbox_inches='tight')
plt.close(fig)
